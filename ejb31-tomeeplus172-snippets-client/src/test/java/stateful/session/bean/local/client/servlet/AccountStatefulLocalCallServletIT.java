...
public class AccountStatefulLocalCallServletIT {
	@Test
    public void test1() throws Exception {		
		try {
			Document doc = Jsoup.parse(new URL("http://localhost:8080/ejb31-tomeeplus172-snippets-web/AccountStatefulLocalCallServlet"), 60000);
