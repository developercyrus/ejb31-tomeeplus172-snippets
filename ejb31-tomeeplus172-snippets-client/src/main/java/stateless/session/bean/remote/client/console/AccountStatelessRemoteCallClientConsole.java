...
import stateless.session.bean.AccountRemote;

public class AccountStatelessRemoteCallClientConsole {
    public static void main(String[] args) throws NamingException, UnknownHostException, RemoteException, CreateException {
        ...
        Object ref = ctx.lookup("java:global/ejb31-tomeeplus172-snippets-ear-0.0.1-SNAPSHOT/ejb31-tomeeplus172-snippets-ejb-0.0.1-SNAPSHOT/stateless.session.bean.Account!stateless.session.bean.AccountRemote");
