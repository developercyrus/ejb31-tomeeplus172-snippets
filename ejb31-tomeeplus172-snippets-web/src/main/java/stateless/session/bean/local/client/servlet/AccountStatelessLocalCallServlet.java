package stateless.session.bean.local.client.servlet;
...
import stateless.session.bean.AccountLocal;


@WebServlet("/AccountStatelessLocalCallServlet")
public class AccountStatelessLocalCallServlet extends HttpServlet  {
	/*	 
	...
	*/
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Object ref = ctx.lookup("java:global/ejb31-tomeeplus172-snippets-ear-0.0.1-SNAPSHOT/ejb31-tomeeplus172-snippets-ejb-0.0.1-SNAPSHOT/stateless.session.bean.Account!stateless.session.bean.AccountLocal");
